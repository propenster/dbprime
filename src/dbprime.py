...
if __name__ == "__main__":
    ...
    pairwise = parser.add_subparsers(dest="pair", help='Sub-commands for two samples')
    ...
    multiple = parser.add_subparsers(dest="multi", help='Sub-commands for multiple samples')
